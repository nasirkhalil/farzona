      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="manage_<?=$pagetype?>.php">Manage Block</a></li>
              ...
              <div class="box box-primary">
                ...
                <form name="addform" method="post" action="" enctype="multipart/form-data">
                  <div class="box-body">
                      ...
                      <div class="col-xs-4">
                      <label>Label</label>
                      <input type="text" class="form-control" name="pre_label_cms" />
                      </div>
                  ...
                  <input name="pre_origin_cms" type="hidden" value="block"/>
