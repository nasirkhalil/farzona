              ...
              <div class="box box-primary">
                ...
                <form name="addform" method="post" action="" enctype="multipart/form-data">
                  ...
                  <? if($data[0]['parent_cat']!=0) {?>
                      ...
                      <div class="col-xs-4">
                      <label>Thumb</label>
                      <input type="file" class="form-control" name="upd_thumb_name_cat" value="<?=$data[0]['thumb_name_cat']?>" />
                      </div>
                      
                      <div class="col-xs-4">
                      <label>Thumb Title</label>
                      <input type="text" class="form-control" name="upd_thumb_title_cat" value="<?=$data[0]['thumb_title_cat']?>" />
                      </div>
                      ...
                      <input type="text" class="form-control" name="upd_thumb_alt_cat" value="<?=$data[0]['thumb_alt_cat']?>" />
                      </div>
                      <div class="clearfix"></div>
                      <div class="col-xs-4">
                      <label>Status</label>
