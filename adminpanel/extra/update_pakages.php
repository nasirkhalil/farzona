              ...
              <div class="box box-primary">
                ...
                <form name="addform" method="post" action="" enctype="multipart/form-data">
                  <div class="box-body">
                      ...
                      <div class="col-xs-4">
                      <label>Price</label>
                      <input type="text" class="form-control" name="upd_price_prd" value="<?=$data[0]['price_prd']?>" />
                      </div>
                      
                      <div class="col-xs-4">
                      <label>Time Range</label>
                      <input type="text" class="form-control" name="upd_timerange_prd" value="<?=$data[0]['timerange_prd']?>" />
                      </div>
