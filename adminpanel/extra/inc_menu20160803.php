<ul class="sidebar-menu">
            ...
            <!-- CONTENT MANAGEMENT -->
            <li class="treeview <? if(stristr($_SERVER['PHP_SELF'],"cms.php")){ echo "active";}; ?>">
              <a href="#">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="manage_video_cms.php"><i class="fa fa-circle-o"></i> Manage Video</a></li>                
              </ul>
            </li>
            <!-- BANNERS MANAGEMENT -->
            ...
            <!-- CONCEPTS MANAGEMENT -->
            <li class="treeview <? if($_GET['type']=="concept"){ echo "active";}; ?>">
              <a href="#">
                <i class="fa fa-umbrella"></i>
                <span>Concepts Management</span>
                <i class="fa fa-angle-left pull-right"></i>                
              </a>
              <ul class="treeview-menu">
                <li><a href="manage_products.php?type=concept"><i class="fa fa-circle-o"></i> Manage Concepts</a></li>                
              </ul>
            </li>
            
            <!-- PROJECTS MANAGEMENT -->
            <li class="treeview <? if($_GET['type']=="project"){ echo "active";}; ?>">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li><a href="manage_products.php?type=project"><i class="fa fa-circle-o"></i> Manage Projects</a></li>                
              </ul>
            </li>
            
            <!-- DIVISIONS MANAGEMENT -->
            <li class="treeview <? if($_GET['type']=="division"){ echo "active";}; ?>">
              <a href="#">
                <i class="fa fa-bullhorn"></i>
                <span>Divisions Management</span>
                <i class="fa fa-angle-left pull-right"></i>                
              </a>
              <ul class="treeview-menu">
                <li><a href="manage_products.php?type=division"><i class="fa fa-circle-o"></i> Manage Divisions</a></li>                
              </ul>
            </li>
            <!-- CLIENTS MANAGEMENT -->
            <li class="treeview <? if(stristr($_SERVER['PHP_SELF'],"_clients.php")){ echo "active";}; ?>">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li><a href="manage_clients.php"><i class="fa fa-circle-o"></i> Manage Clients</a></li>                
              </ul>
            </li>
            ...
            <li class="treeview <? if(stristr($_SERVER['PHP_SELF'],"_contact.php") || stristr($_SERVER['PHP_SELF'],"enquiry.php") || stristr($_SERVER['PHP_SELF'],"propsell.php")){ echo "active";}; ?>">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="manage_enquiry.php"><i class="fa fa-circle-o"></i> Manage Footer Enquiries</a></li>
