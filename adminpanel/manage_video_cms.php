...
// origin in parameter 'menu', 'block' etc .. If empty, default is  'menu'
$optbyid = $general->getAll(" content_cms where origin_cms = 'video' ");
?>
<!DOCTYPE html>
<html>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title" style="float:right !important;"><?php /*?><a href="add_<?=$pagetype?>.php">Add Block</a><?php */?></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                <? if(is_array($optbyid)){ ?>
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <? for($d=0; $d<count($optbyid); $d++){ ?>
                    	<tr>
                        	<td><?=$optbyid[$d]['label_cms']; if($conf->ar==1){ echo " | ".$optbyid[$d]['namear_cms'];}?></td>
