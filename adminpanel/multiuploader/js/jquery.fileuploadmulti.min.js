...
(function(b) {
    ...
    b.fn.uploadFile = function(t) {
        var r = b.extend({
            ...
            uploadButtonClass: "upload_custom",
            dragDropStr: "",
            abortStr: "Abort",
            cancelStr: "Cancel",
            deletelStr: "Delete",
        ...
        (function k() {
            if (b.fn.ajaxForm) {
                if (r.dragDrop) {
                    var s = b('<div class="ajax-upload-dragdrop-custom btn btn-primary" style="vertical-align:top;"></div>');
                    b(m).before(s);
                    b(s).append(e);
        ...
        function q(y, B, D, u) {
            ...
            var v = "<input type='file' id='" + A + "' name='" + D.fileName + "' class='my_class'/>";
            if (D.multiple) {
                if (D.fileName.indexOf("[]") != D.fileName.length - 2) {
                    D.fileName += "[]"
                }
                v = "<input type='file' id='" + A + "' name='" + D.fileName + "' multiple class='my_class'/>"
            }
