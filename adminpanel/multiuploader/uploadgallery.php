...
if(isset($_FILES["myfile"]))
{
	...
	$error =$_FILES["myfile"]["error"];
   {
    	...
    	{            
			 ...
			 $thumbnil_image =$conf->absolute_path.$conf->gallery_dir."_".$product_image;
			// Resize image (options: exact, portrait, landscape, auto, crop)
			resizeImage($path_product_image,$conf->galleryThumbnailWidth, $conf->galleryThumbnailHeight, 'crop');
			// Save image
