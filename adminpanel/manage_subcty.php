...
$optbyid=$general->getAll("ccity_cty where parent_cty= ".$_GET['cid']."");
?>
<!DOCTYPE html>
<html>
            ...
            <div class="col-xs-12">
              <div class="box">
                ...
                <? 	   }
                  ...
                  <h3 class="box-title" style="float:right !important;"><a href="add_emirates.php">Add Location</a></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                <? if(is_array($optbyid)){ ?>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
					...
					?>
                    	<tr>                        	
                            <td><?=$optbyid[$d]['name_cty']?></td>
                            <td><? if($optbyid[$d]['status_cty']==1)
				   { ?><a href='?status=Inactive&st_id=<?=base64_encode($optbyid[$d]['id_cty'])?>&cid=<?=base64_encode($_GET['cid'])?>'>Active</a><? }  else { ?><a href='?status=Active&st_id=<?=base64_encode($optbyid[$d]['id_cty'])?>&cid=<?=base64_encode($_GET['cid'])?>'>Inactive</a><? } ?></td>
                            ...
                            <a href="update_emirates.php?id=<?php echo base64_encode($optbyid[$d]['id_cty'])?>" target="_self" title="Edit"><img src="dist/img/icons/pencil.png" alt="Edit" /></a>
