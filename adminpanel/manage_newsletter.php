...
if(isset($_POST['delete'])){
	$general->delmulti("newsletter_newl","id_newl","","");
}
if(isset($_GET['id'])){
	$general->delGenDetails("newsletter_newl","id_newl","","");
}

$optbyid=$general->getAll(" newsletter_newl order by id_newl desc ");
?>
<!DOCTYPE html>
<html>
                ...
                <? if(is_array($optbyid)){ ?>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <? for($d=0; $d<count($optbyid); $d++){?>
                    	<tr> 
                        <td><input type="checkbox" name="checkbox[]" class="case" value="<? echo $optbyid[$d]['id_newl'];?>" /></td>                       	
                            
                            <td><?=$optbyid[$d]['email_newl']?></td>
                             
                            <td><?=$optbyid[$d]['date_newl']?></td>
                            <td style="text-align:center !important;">
                            <?php /*?><!--view-->
                            <a href="#" class="view" id="<?php echo $optbyid[$d]['id_newl']?>" ><img src="dist/img/icons/view.png" alt="Edit" /></a><?php */?>
                            <!--delete-->
                            <a href="#" class="delete" id="<? echo $optbyid[$d]['id_newl'];?>"><img src="dist/img/icons/cross.png" alt="Delete" /></a>
                            </td>
                        </tr>
                    <? } ?>  
                    </tbody> 
